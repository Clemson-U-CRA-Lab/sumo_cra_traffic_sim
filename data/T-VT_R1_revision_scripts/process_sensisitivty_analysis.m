...
% For TVT DOS paper - Revision R1 - Sensitivty plot
...
%% ===== Paths =====
% Script lives in data/T-VT_R1_revision_scripts/; CSVs stay under the
% original experiment date folders.
scriptDir = fileparts(mfilename('fullpath'));
if isempty(scriptDir), scriptDir = pwd; end
dataRoot     = fileparts(scriptDir);  % .../data
julyFolder   = fullfile(dataRoot, '2026_07_24', 'processed');
augustFolder = fullfile(dataRoot, '2026_08_01');
outDir       = fullfile(scriptDir, 'plots_sensitivity');
...
runInputs = [ ...
    runInput('nominal', 'nominal', NaN, NaN, NaN, 'Nominal', fullfile(julyFolder, 'run1_sumIndoorVIL_log_2026_07_24-01_02_23_PM.csv')); ...
    runInput('288B_10PPS_3C', '3', 3, 288, 10, 'Client count', fullfile(julyFolder, 'run2_sumIndoorVIL_log_2026_07_24-01_35_10_PM.csv')); ...
    runInput('288B_10PPS_6C', '6', 6, 288, 10, 'Client count', fullfile(julyFolder, 'run3_sumIndoorVIL_log_2026_07_24-01_41_26_PM.csv')); ...
    % runInput('288B_10PPS_9C', '9', 9, 288, 10, 'Client count', fullfile(julyFolder, 'run4_sumIndoorVIL_log_2026_07_24-01_50_52_PM.csv')); ...
    % runInput('288B_10PPS_12C', '12', 12, 288, 10, 'Client count', fullfile(julyFolder, 'run5_sumIndoorVIL_log_2026_07_24-01_54_57_PM.csv')); ...
    runInput('288B_10PPS_15C', '15', 15, 288, 10, 'Client count', fullfile(julyFolder, 'run6_sumIndoorVIL_log_2026_07_24-02_01_36_PM.csv')); ...
    % runInput('288B_10PPS_18C', '18', 18, 288, 10, 'Client count', fullfile(julyFolder, 'run7_sumIndoorVIL_log_2026_07_24-02_07_01_PM.csv')); ...
    runInput('288B_10PPS_21C', '21', 21, 288, 10, 'Client count', fullfile(julyFolder, 'run8_sumIndoorVIL_log_2026_07_24-02_13_09_PM.csv')); ...
    % runInput('288B_10PPS_24C', '24', 24, 288, 10, 'Client count', fullfile(julyFolder, 'run9_sumIndoorVIL_log_2026_07_24-02_17_58_PM.csv')); ...
    % runInput('288B_10PPS_27C', '27', 27, 288, 10, 'Client count', fullfile(julyFolder, 'run10_sumIndoorVIL_log_2026_07_24-02_23_26_PM.csv')); ...
    runInput('288B_10PPS_30C', '30', 30, 288, 10, 'Client count', fullfile(julyFolder, 'run11_sumIndoorVIL_log_2026_07_24-02_28_20_PM.csv')); ...

    runInput('400B_10PPS_15C', '400', 15, 400, 10, 'Packet size', fullfile(julyFolder, 'run12_sumIndoorVIL_log_2026_07_24-02_40_17_PM.csv')); ...
    % runInput('500B_10PPS_15C', '500', 15, 500, 10, 'Packet size', fullfile(julyFolder, 'run13_sumIndoorVIL_log_2026_07_24-02_44_59_PM.csv')); ...
    runInput('600B_10PPS_15C', '600', 15, 600, 10, 'Packet size', fullfile(julyFolder, 'run14_sumIndoorVIL_log_2026_07_24-02_50_51_PM.csv')); ...
    % runInput('700B_10PPS_15C', '700', 15, 700, 10, 'Packet size', fullfile(julyFolder, 'run15_sumIndoorVIL_log_2026_07_24-02_56_05_PM.csv')); ...
    runInput('800B_10PPS_15C', '800', 15, 800, 10, 'Packet size', fullfile(julyFolder, 'run16_sumIndoorVIL_log_2026_07_24-03_03_04_PM.csv')); ...
    % runInput('900B_10PPS_15C', '900', 15, 900, 10, 'Packet size', fullfile(julyFolder, 'run17_sumIndoorVIL_log_2026_07_24-03_11_50_PM.csv')); ...
    runInput('1000B_10PPS_15C', '1000', 15, 1000, 10, 'Packet size', fullfile(julyFolder, 'run18_sumIndoorVIL_log_2026_07_24-03_17_46_PM.csv')); ...

    runInput('20PPS_15C', '20', 15, 288, 20, 'Packet rate', fullfile(julyFolder, 'run19_sumIndoorVIL_log_2026_07_24-03_26_20_PM.csv')); ...
    runInput('30PPS_15C', '30', 15, 288, 30, 'Packet rate', fullfile(julyFolder, 'run20_sumIndoorVIL_log_2026_07_24-03_33_18_PM.csv')); ...
    runInput('40PPS_15C', '40', 15, 288, 40, 'Packet rate', fullfile(julyFolder, 'run21_sumIndoorVIL_log_2026_07_24-03_38_22_PM.csv')); ...
    runInput('50PPS_15C', '50', 15, 288, 50, 'Packet rate', fullfile(julyFolder, 'run22_sumIndoorVIL_log_2026_07_24-03_53_19_PM.csv')); ...
    runInput('70PPS_15C', '70', 15, 288, 70, 'Packet rate', fullfile(julyFolder, 'run24_sumIndoorVIL_log_2026_07_24-04_03_19_PM.csv')); ...
    % runInput('90PPS_15C', '90', 15, 288, 90, 'Packet rate', fullfile(julyFolder, 'run26_sumIndoorVIL_log_2026_07_24-04_20_34_PM.csv')); ...
