# This script will ru on the on-vehicle computer - sends gps info to RS-PC
...
def main():
    ...
    while step < 200:
        ...
        if nv0 in vehicle_list:
            ...
            send_nv_info(client_socket, server_address, nv_spd=nv0_spd_t, nv_pos=[nv0_pos_t, nv0_dist_t, nv0_lane_t])
